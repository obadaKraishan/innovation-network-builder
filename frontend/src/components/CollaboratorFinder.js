...
import { FaSearch, FaBuilding, FaUserAlt, FaEnvelope, FaUsersCog } from 'react-icons/fa';
...
const CollaboratorFinder = () => {
  ...
  return (
    <div className="flex h-screen">
      <Sidebar />
      <main className="flex-1 bg-gradient-to-br from-gray-100 to-gray-200 p-6 overflow-y-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
          <FaUsersCog className="mr-3 text-blue-500" />
          Find Collaborators
        </h1>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
          <form onSubmit={handleSearch}>
            ...
            <div className="mb-6">
              <label className="block text-gray-700 mb-2 font-semibold flex items-center">
                <FaUsersCog className="mr-2 text-gray-600" />
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white p-3 rounded-lg font-semibold hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-700 flex items-center justify-center"
            >
