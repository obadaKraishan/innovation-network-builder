  ...
  try {
    ...
    const users = [
      ...
      // IT Department
      {
        ...
        department: departments.find(dept => dept.name === 'Software Development' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'IT')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Team Leader',
        department: departments.find(dept => dept.name === 'Network Security' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'IT')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'DevOps' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'IT')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'Quality Assurance' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'Research and Development')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Team Leader',
        department: departments.find(dept => dept.name === 'Recruitment' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'HR')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'Compensation and Benefits' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'HR')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'Payroll' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'Finance')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'International Sales' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'Sales')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Team Leader',
        department: departments.find(dept => dept.name === 'Market Research' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'Marketing')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'Corporate Law' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'Legal')._id))._id,
      ...
      },
      {
        ...
        password: await bcrypt.hash('password123', 10),
        role: 'Employee',
        department: departments.find(dept => dept.name === 'Call Center Operations' && dept.parentDepartment.equals(departments.find(mainDept => mainDept.name === 'Customer Support')._id))._id,
